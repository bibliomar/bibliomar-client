            ...
            <div className="mb-5">
                ...
                {i18n.language !== "pt-br" ? (
                    <h5 className="text-center">
                        We are working to translate this resource. Thank your
                        for your patience!
                    </h5>
                ) : null}
            </div>
            ...
            >
                <MDBAccordion initialActive={ref} className="text-color">
                    <MDBAccordionItem
                        ...
                        collapseId={1}
                        headerTitle={t("faq:comoFuncionaAPesquisaEstruturada")}
                    >
                        <p>
                            {t(
                ...
                <MDBAccordion initialActive={ref}>
                    ...
                    >
                        ...
                        <ul>
                            ...
                            <li>{t("faq:tentePesquisarEmOutraCategoria")}</li>
                            <li>
                                <span>
                    ...
                    <MDBAccordionItem
                        className="text-color"
                        collapseId={80}
                        headerTitle={t("faq:comoTornamosOBibliomarSeguro")}
                    >
                        <p>
                            {t(
                                "faq:maisImportanteDoQuAdicionarNovasFunesTornarAsExist"
                            )}
                        </p>
                        <br />
                        <p>
                            {t(
                                "faq:primeiramenteTodasAsRotasDoBibliomarTantoDoCliente"
                            )}
                        </p>
                        <span>
                            {t(
                                "faq:emResumoIssoSignificaQueOsSeusDadosTemCriptografia"
                            )}
                        </span>
                        <br />
                        <p>
                            {t(
                                "faq:almDissoTodasAsSenhasEInformaesSensveisDosUsuarios"
                            )}
                        </p>
                        <span>
                            <Trans
                                i18nKey="nsUsamosOAlgortimoDeCriptografiaPbkdf2ParaCriptogr"
                                ns="faq"
                                values={{
                                    expr: " ",
                                }}
                        ...
                        <span>
                            <Trans
                                i18nKey="eParaComplementarASeguranaTambmUtilizamosOAlgortim"
                                ns="faq"
                                components={{
                                    i: <i />,
                                }}
                        ...
                        <p>
                            <Trans
                                i18nKey="emTermosSimplesIssoSignificaQueNingumPodeVisualiza"
                                ns="faq"
                                values={{
                                    expr: " ",
                                }}
                        ...
                        <span>
                            {t(
                                "faq:oQueTambmSignificaQueEmCasoDePerdaDeSenhaNsSPodere"
                            )}
                        </span>
                        <h5 className="mt-3 mb-3">
                            {t(
                                "faq:seNingumPodeSaberMinhaSenhaComoEuConsigoFazerLogin"
                            )}
                        </h5>
                        <span>
                            {t(
                                "faq:simplesQuandoVocDigitaSuaSenhaETentaFazerLoginNsCr"
                            )}
                        </span>
                        <br />
                        <span>
                            {t(
                                "faq:seOsHashsCoincidemOUsuarioRecebePermissoParaAcessa"
                            )}
                        </span>
                        <br />
                        <br />
                        <p>
                            {t(
                                "faq:noExisteNenhumaFormaDeFalsificarEsseHashOuBurlarEs"
                            )}
                        </p>
                    </MDBAccordionItem>
                </MDBAccordion>
